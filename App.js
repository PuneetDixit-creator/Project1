...
const API_KEY = '9ef0ba7a80d876cd4b37888b799c5abb'; 
  ...
  const fetchWeather = async (city) => {
    try {
      const weatherResponse = await axios.get(
        `https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=${9ef0ba7a80d876cd4b37888b799c5abb}&units=metric`
      );
      setWeatherData([...weatherData, weatherResponse.data]);

      // Fetch forecast
      const forecastResponse = await axios.get(
        `https://api.openweathermap.org/data/2.5/forecast?q=${city}&appid=${9ef0ba7a80d876cd4b37888b799c5abb}&units=metric`
      );
